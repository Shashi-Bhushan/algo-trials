...
import static in.shabhushan.algo_trials.bits.Divide.*;
import static org.junit.Assert.assertEquals;

public class DivideTest {
  @Test
  public void test() {
    assertEquals(2684354560L, reverse(5L));
    assertEquals(2684354560L, reverse(6L));
    assertEquals(62, divide(124, 2));
    assertEquals(Integer.MAX_VALUE, divide(Integer.MIN_VALUE, -1));
  }

  @Test
  public void test2() {
    assertEquals(0, searchMatrix(new int[][]{
        {1},
        {4}
    }, 14));
  }
